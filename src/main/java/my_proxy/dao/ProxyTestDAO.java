...
import my_proxy.mapper.ProxyTestMapper;
...
public class ProxyTestDAO {
    @Autowired
    ProxyTestMapper mapper;

    public List<ProxyTest> getAll() {
        List<ProxyTest> result = new ArrayList<>();
    ...
    public ProxyTest getById(int id) {
        try (Connection connection = DriverManager.getConnection(DbUtils.getUrl());
    ...
    public List<ProxyTest> getByGroupId(int id) {
        List<ProxyTest> result = new ArrayList<>();
        try (Connection connection = DriverManager.getConnection(DbUtils.getUrl());
